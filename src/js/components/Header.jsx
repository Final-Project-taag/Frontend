      ...
      <div className=" flex  justify-between items-center  py-1 px-1 bg-gray-800">
        <div className="flex  justify-start  ">
          <Link to="/">
            ...
            <button className=" py-1 px-1 " type="button">
              <img src="vite.svg" className=" h-14 w-10 text-gray-700" />
            </button>
          </Link>
        </div>
        ...
        <div className="flex justify-center  items-center">
          <ul className="flex justify-center items-center gap-5 ">
            <li className=" font-bold text-green-600 hover:text-green-800">
              <Link to="/booking">Booking</Link>
            </li>
             {/* <li className=' font-bold text-2xl text-green-500 hover:text-green-700'><Link to='/services'>services</Link></li>
                        <li className=' font-bold text-2xl text-green-500 hover:text-green-700'><Link to='/Abo'>Abo</Link></li>  */}
            <li className=" font-bold text-2xl text-green-500  *hover:text-green-700">
            ...
            <li className=" font-light text-2xl text-green-500 hover:text-green-300">
