        ...
        <div className="flex justify-between mx-auto  py-5 px-2">
            ...
            <nav className="flex justify-between mx-auto  py-5 px-2">
                <ul className="flex justify-center items-center gap-4 ">
                    ...
                    <li className=' font-bold text-green-600 hover:text-green-800'><Link to='/services'>Vehicles</Link></li>
                    <li className=' font-bold text-green-600 hover:text-green-800'><Link to='/Abo'>Booking</Link></li>
