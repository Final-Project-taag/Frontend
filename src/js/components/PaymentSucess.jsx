  ...
  useEffect(() => {
    const verifyPayment = async () => {
      try {
        ...
        const response = await axios.get(`https://green-wheels-backend.onrender.com/payment/payment-update/${reservationId}`, {
          headers: {
  ...
  if (success) {
    ...
    return (
      <div>
        ...
        <p>
          Leider ist ein Problem mit Ihrer Zahlung aufgetreten. Bitte versuchen Sie es erneut oder kontaktieren Sie uns für weitere Unterstützung.
        </p>
      </div>
    )
  }
