        ...
        <>
            <div>
                <div className='text-center bg-black-500  mb-6' >
                    ...
                    <p className='font-sans  text-center ml-10 mr-10' ml-10 >Unser Ziel ist es, unsere Kunden mit einer Vielzahl der neuesten Elektrofahrzeuge zu begeistern. Wir haben einen langen Weg hinter uns und wissen daher am besten, wie wir Sie mit modernen ökologischen Fahrzeuge und dennoch preiswert zu mieten begeistern können. Wir bieten all dies bei gleichzeitig exzellentem Kundenservice und freundlichem Support.</p>
                ...
                <div className='flex flex-row mx-2'>
                    <div className='basis-1/3'>
                        ...
                        <img className='w-61 min-h-full' src={'/images/autos_01.jpg'} alt="Elektro Autos" />
                    </div>

                    <div className='basis-1/3' >
                        <span className='ml-8 ml-4 text-blue-600' >Elektrische Motorraeder</span>
                        <img className='w-61 min-h-full ml-9 mr-20' src={'/images/motorrad_05.jpg'} alt="Elektrische Motorraeder" />
                    </div>

                    <div className='basis-1/3' >
                        <p className='ml-4 text-blue-600' >Elektroroller</p>
                        <img className='w-61 min-h-full ml-4 mr-8 ' src={'/images/scooter_03.jpg'} alt="Elektroroller" />
                    </div>
                </div>
            </div>
