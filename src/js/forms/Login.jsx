...

      {
        ...
        authStore.isAuthenticated() ? (
          <button
            ...
            className="flex items-center  justify-center  text-gray-700 font-sans py-1 px-1  focus:outline-none focus:shadow-outline"
            type="button"
          >
            <svg
              className="h-12 w-10 text-gray-700"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              strokeWidth="2"
        ...
        notVerified ? (
          ...
          <form
            className="w-full max-w-md flex-col items-center justify-center  md:shadow-xl  md:border-2 md:rounded-xl px-10 py-5 "
          ...
          >
            ...
            <div className="mb-6 ">
              ...
              <input
                className="w-full shadow appearance-none  rounded  py-2 px-3 text-gray-700 mb-3 leading-tight "
                id="username"
                type="text"
