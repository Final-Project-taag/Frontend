  ...
  return (
    <div className="pt-20 h-[95vh]">
      ...
      <div className="w-11/12 lg:w-3/4 flex lg:max-h-full flex-col   text-center  mt-6 md:mt-10 mb-2">
        <h1 className="text-4xl md:text-6xl  text-green-600 dark:text-green-500">
          Green <span className="text-gray-600 dark:text-gray-500">Wheels</span>{" "}
        </h1>
