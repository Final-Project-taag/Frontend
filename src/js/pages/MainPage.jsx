...
function MainPage() {
  ...
  return (
    <div className="pt-14 h-screen">
      ...
      <div className=" bg-cover bg-no-repeat bg-center bg-[url('/eco-car-forest-road-with-earth-planet.webp')] flex justify-between w-full py-20 px-1 h-20 md:w-auto  md:h-[20vh] xl:h-[40vh]"></div>

      <div className="w-3/4 flex max-h-full flex-col   text-center mt-10 mb-10">
        <h1 className="text-2xl xl:text-6xl  text-green-600">
          Green <span className="text-gray-600">Wheels</span>{" "}
        </h1>
        <Typewriter text={introText} />
        <button
          onClick={handletovehicle}
